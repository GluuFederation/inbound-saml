...
const fakeMetadata: IMetadata = {
  ...
  idpssoDescriptor: {
    ...
    keyDescriptor: [
      {
        use: 'Et rerum doloremque aspernatur deserunt explicabo non adipisci qui. Rerum aut aperiam pariatur quis aut eius. Eum id cum exercitationem esse accusantium.\n \rMagnam numquam iure. Soluta aliquam aspernatur quis cumque libero incidunt. Quaerat quod et. Fugiat saepe illum enim accusantium sunt nihil est ut impedit. Qui est commodi commodi temporibus error sunt. Molestiae explicabo exercitationem porro sit quos ipsum quia in aut.\n \rEt magnam laborum dolorem nam laboriosam quaerat nobis sint ad. Ut voluptatibus quo. Vero minima quo ullam esse omnis aut praesentium. Quia autem porro cumque. Odio autem temporibus. Ipsum rem minus natus nobis id eaque qui dignissimos animi.',
        keyInfo: {
          x509Data: {
      ...
      {
        use: 'Impedit libero odit quo excepturi commodi occaecati neque. Illum cupiditate tempore doloremque et qui et. Modi reiciendis expedita eaque qui labore consequatur doloremque eos.',
        keyInfo: {
          x509Data: {
